...
const Modal = ({ tournament, closeModal, captainName, teamName, players, handleCaptainNameChange, handleTeamNameChange, handlePlayerNameChange, handleAddPlayer, handleRemovePlayer, handleSubmit }) => {
  return (
