...
const LoginModalAdmin = ({ onClose }) => {
  ...
  const handleSignIn = async () => {
    try {
      ...
      const userSnapshot = await firebase.firestore().collection('Axiomsadmin').doc(user.uid).get();
  ...
  const handleSignUp = async () => {
    try {
      ...
      await firebase.firestore().collection('Axiomsadmin').doc(user.uid).set({
        username: username,
        email: email
      });
